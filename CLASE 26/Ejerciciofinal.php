...
<body>
		...
		{
			if(strlen($_GET["apellidos"])==0)
			{
				echo "<p>Introduzca sus apellidos</p>";
			}
			else
			{
		...
		if (isset($_GET["sexo"]))
		{
			if(strcmp($_GET["sexo"], "M"))
			{
				echo "<p>Es varón</p>";
			}
			else
			{
				if(strcmp($_GET["sexo"], "H"))
				{
					echo "<p>Es hembra</p>";
				}
				else
				{
					echo "<p>Introduzca un sexo correcto</p>";
				}
			}
		}
		...
		if (isset($_GET["pais"]))
		{
			...
			{
			case "ES":
				echo "<p>País: España</p>";
			break;
			case "PT":
				echo "<p>País: Portugal</p>";
			break;
			case "AN":
				echo "<p>País: Andorra</p>";
			break;
			default:
				echo "<p>Pais no identificado. Introduzca un país correcto</p>";
			break;
		}
		}
		...
		{
			if(strlen($_GET["localidad"])==0)
			{
				echo "<p>Introduzca su localidad</p>";
			}
			else
			{
				echo "</p>Localidad: " . $_GET["localidad"] . "</p>";
			}
		}
		...
		if (isset($_GET["edad"]))
		{
			if(strlen($_GET["edad"])==0)
			{
				echo "<p>Introduzca su edad</p>";
			}
			else
			{
				echo "</p>Años: " . $_GET["edad"] . "</p>";
			}
		}
		?>
		<form>
