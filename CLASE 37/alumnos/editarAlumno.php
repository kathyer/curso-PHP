<?php
	...
	if ($_POST) {
		...
		{	
			/*
			$consulta2 = "UPDATE alumnos SET nombre='" . $_POST["nombre"] . "', apellidos='" . $_POST["apellidos"] . "', edad=" . $_POST["edad"] . ", curso='" . $_POST["curso"] . "', altura=" . $_POST["altura"] . ", sexo='" . $_POST["sexo"] . "' WHERE id_alumno=" . $_GET["id"] . ";";
			*/

			$consulta = crearConsultaActualizar($_POST, "alumnos", "id_alumno", $_GET["id"]);
