<?php
	...
	function operacion($numero1, $numero2, $operacion)
	{
		switch ($operacion)
		{
			case 'sumar': return $numero1 + $numero2; break;
			case 'restar': return $numero1 - $numero2; break;
			case 'multiplicar': return $numero1 + $numero2; break;
			case 'dividir': return $numero1 / $numero2; break;
		}
	}

	function convertirNaturalARomano($num)
	{
		if ($num <0 || $num >9999)
		{
			return -1;
